...
class BubbleSort(Scene):
    def construct(self):
        self.add(Text("Bubble Sort(optimized)", font_size=64).move_to([0, 9, 0]))
        ...
        txt = Text(r"Loop 1", font_size=200, color=RED, stroke_width=5)
        ...
        txt = Text(r"Loop 2", font_size=200, color=RED, stroke_width=5)
        ...
        txt = Text(r"Loop 3", font_size=200, color=RED, stroke_width=5)
        self.play(GrowFromCenter(txt))
        self.remove(txt)
        ...
        txt = Text(r"Loop 4", font_size=200, color=RED, stroke_width=5)
        self.play(GrowFromCenter(txt))
        self.remove(txt)
        self.play(brace.animate.shift(numpy.array([0, -1.5, 0])))
        self.play(groups[list.index(10)].animate.shift(numpy.array([0, -1.5, 0])),
        ...
        txt = Text(r"Loop 5", font_size=200, color=RED, stroke_width=5)
        self.play(GrowFromCenter(txt))
        self.remove(txt)
        ...
        txt = Text(r"Loop 6", font_size=200, color=RED, stroke_width=5)
        self.play(GrowFromCenter(txt))
        self.remove(txt)
        ...
        txt = Text(r"Loop 7", font_size=200, color=RED, stroke_width=5)
        self.play(GrowFromCenter(txt))
        self.remove(txt)
        self.play(brace.animate.shift(numpy.array([0, -1.5 * 4, 0])))
        self.play(groups[list.index(10)].animate.shift(numpy.array([0, -1.5, 0])),
        ...
        txt = Text(r"Loop 8", font_size=200, color=RED, stroke_width=5)
        self.play(GrowFromCenter(txt))
        self.remove(txt)
        self.play(brace.animate.shift(numpy.array([0, -1.5 * 4, 0])))
        self.play(groups[list.index(10)].animate.shift(numpy.array([0, -1.5, 0])),
        ...
        txt = Text(r"Loop 9", font_size=200, color=RED, stroke_width=5)
        self.play(GrowFromCenter(txt))
        self.remove(txt)
        self.play(brace.animate.shift(numpy.array([0, -1.5 * 3, 0])))
        self.play(groups[list.index(10)].animate.shift(numpy.array([0, -1.5, 0])),
        ...
        txt = Text(r"Done", font_size=150, color=RED, stroke_width=5)
        self.play(GrowFromCenter(txt))
        self.remove(txt)
        self.wait(3)
